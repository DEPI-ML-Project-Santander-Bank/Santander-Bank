...
def check_fake_rows(df):
    ...
    # Check for outliers in the data using z-score
...
def train_and_evaluate_models(X, y, n_splits=10):
    ...
    scaler = StandardScaler()  # Move scaler outside the loop to avoid repeated fitting
